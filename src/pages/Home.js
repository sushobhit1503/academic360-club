            ...
            <div>
                ...
                <div className="main-container mt-5">
                    <div className="row row-cols-1 row-cols-md-2 g-3">
                        <div className="col">
                            <div className="h2 mb-5 text-secondary">
                                Who We Are
                            </div>
                            <div className="h5">
                        ...
                        <div className="col">
                            <div className="d-md-flex d-none align-items-center gap-3 justify-content-center h-100">
                                <div className="who-image-1">
                                </div>
                                <div className="who-image-2">
                                </div>
                            </div>
                            <div className="d-flex d-md-none align-items-center gap-3 justify-content-center h-100 flex-wrap">
                                <div className="mb-3">
                ...
                <div className="text-center bg-primary p-3 py-5 p-md-5 mt-5">
                    <div className="h2 text-primary mb-5">Our Services</div>
                ...
                <div className="text-center main-container mt-5">
                    <div className="h2 text-secondary mb-5">Why Choose us?</div>
                ...
                <div className="bg-primary mt-5 p-3 py-5 p-md-5">
                    <div className="row row-cols-1 row-cols-xl-2 g-3">
                        <div className="col text-center">
                            <img src={Mission} alt="academics360" className="mission-image" />
                        </div>
                        <div className="col">
                            <div className="h2 mb-5 text-primary">Our Mission</div>
                ...
                <div className="my-5 main-container">
                    <div className="row row-cols-1 row-cols-xl-2 g-3">
                        <div className="col">
                            <div className="h2 mb-5 text-secondary">Contact Us</div>
                            <div className="mb-3">
                                <Label>Name</Label>
