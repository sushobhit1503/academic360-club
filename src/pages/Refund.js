        ...
        return (
            <div style={{paddingTop:"120px"}} className="main-container">
                ...
                <div className="mb-3">
                    ...
                    including a transparent and fair refund policy. Please take a moment to familiarize
                    yourself with our refund policy outlined below:
                </div>
                ...
                <div className="mb-3">
                    3.1. In exceptional cases, where there is a technical issue or failure in service delivery from a
                    counselor on our platform, we will work closely with the affected user to resolve the issue or
